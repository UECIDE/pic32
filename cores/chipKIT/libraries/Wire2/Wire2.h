 ...
 * -----------------------------
 * What I saw is that there is some sort of h/w initialization issue in the twi2_init() code.
 * I tracked it down to the twi2_init() function down in the pic32 libraries/Wire/utility/twi.c
 ...
 * 
 * The system really doesn't lock up there, as the twi2_init() function does return.
 ...
 * ======================
 *
 * There is a major flaw in the twi2_init function which, if called twice,
