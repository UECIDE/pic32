...
#define twi2_h
  ...
  #ifndef TWI2_FREQ
  #define TWI2_FREQ 100000
  #endif

  #ifndef TWI2_BUFFER_LENGTH
  #define TWI2_BUFFER_LENGTH 32
  #endif
...
#define latLED4		LATF
  ...
  void twi2_setAddress(uint8_t);
  uint8_t twi2_readFrom(uint8_t, uint8_t*, uint8_t);
  uint8_t twi2_writeTo(uint8_t, uint8_t*, uint8_t, uint8_t);
  uint8_t twi2_transmit(uint8_t*, uint8_t);
  void twi2_attachSlaveRxEvent( void (*)(uint8_t*, int) );
  void twi2_attachSlaveTxEvent( void (*)(void) );
